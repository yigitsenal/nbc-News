  ...
  <div>
    <div class="nav-bar">
      ...
      <div>
        <div class="fill-category">
          <img src="../images/Fill-category.png" alt="" />
        </div>
      </div>

      <div class="place-holder-h1">
        <h1>En Son Hikayeler</h1>
      </div>

      <div class="place-holder-h2">
        <h1>Düşünce</h1>
      </div>
      <div class="place-holder-h3">
        <h1>Sağlık</h1>
      </div>
    </div>
    <div v-if="news != null" class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">Kaynak: {{ news[1].source }}</small>
        </p>
      </div>
    </div>
    <div v-if="news != null" class="card-2">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">Kaynak: {{ news[2].source }}</small>
        </p>
      </div>
    </div>
    <div v-if="news != null" class="card-3">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">Kaynak: {{ news[3].source }}</small>
        </p>
      </div>
    </div>
    <div v-if="news != null" class="card-4">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">Kaynak: {{ news[4].source }}</small>
        </p>
      </div>
    </div>
